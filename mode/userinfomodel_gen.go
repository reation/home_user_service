...
func (m *defaultUserInfoModel) Insert(ctx context.Context, data *UserInfo) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.LoginUsername, data.LoginPassword, data.Name, data.Icon, data.Gender, data.Status, data.Type, data.BId)
	}, userInfoIdKey)
	return ret, err
}
...
func (m *defaultUserInfoModel) Update(ctx context.Context, data *UserInfo) error {
	...
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.LoginUsername, data.LoginPassword, data.Name, data.Icon, data.Gender, data.Status, data.Type, data.BId, data.Id)
	}, userInfoIdKey)
	return err
}
